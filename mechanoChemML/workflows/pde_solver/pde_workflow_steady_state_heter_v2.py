...
class PDEWorkflowSteadyState:
    ...
    def _compute_residual(self, features, y_pred, only_y_pred=False):
        ...
        if self.UseTwoNeumannChannel :
            ...
            raise ValueError('Not implemented for self.UseTwoNeumannChannel:', self.UseTwoNeumannChannel)
    ...
    def _loss_probabilistic(self):
        ...
        def loss(y_true, y_pred):
            ...
            if self.UseTwoNeumannChannel :
                inputs = y_pred[:,:,:,self.dof:5*self.dof] # new Neumann Channel
            else:
                raise ValueError('Not implemented for self.UseTwoNeumannChannel:', self.UseTwoNeumannChannel)
