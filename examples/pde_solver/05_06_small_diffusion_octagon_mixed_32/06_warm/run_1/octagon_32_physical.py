...
def plot_bvp_results_with_quantitative_line(pixel=32):
    ...
    if pixel == 32:
        # cnn
        saved_data = "results/2022-03-12T05-01-exp-10-59-NN-cnn-x14-B512-E20000-I50-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-....data-20220312050122.pickle"
    elif pixel == 64:
        saved_data = None
    ...
    if pixel == 32:
        # cnn
        saved_data = "results/2022-03-19T02-33-exp-14-60-BNN-bnn-5-x14-B256-E20000-I100-mc100-1S2.0e-04-2S1.0e-03-Nadam-2.0e-06-....data-20220319023326.pickle"
    elif pixel == 64:
        saved_data = None
    sys.argv[3] = saved_data
    problem = thisPDESystem()
