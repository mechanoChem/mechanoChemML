...
def plot_bvp_results_with_quantitative_line(pixel=32):
    ...
    if pixel == 32:
        # cnn
        saved_data = "results/2020-12-17T08-20-NN-diffusion-e8-32-cnn-x12-B256-E5000-I50-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-datae8-32-D1.0-20201217082006.pickle"
    elif pixel == 64:
        saved_data = "results/2020-12-18T14-42-NN-diffusion-e8-64-cnn-x12-B256-E5000-I50-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-datae8-64-D1.0-20201218144210.pickle"
    ...
    if pixel == 32:
        # cnn
        saved_data = "results/2021-01-01T15-12-BNN-diffusion-e8-32-bnn-x11-B64-E100-I50-mc100-1S1.0e-04-2S1.0e-04-Nadam-1.0e-08-datae8-32-D1.0-20210101151258.pickle"
    elif pixel == 64:
        saved_data = "results/2021-01-01T15-04-BNN-diffusion-e8-64-bnn-x11-B64-E100-I50-mc100-1S1.0e-04-2S1.0e-04-Nadam-1.0e-08-datae8-64-D1.0-20210101150402.pickle"
    sys.argv[3] = saved_data
    problem = thisPDESystem()
    problem.run()
    _inputs, _labels, _mean, _var, _std = problem.test(test_folder='DNS', plot_png=False)
