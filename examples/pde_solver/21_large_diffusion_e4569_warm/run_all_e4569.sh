...
all_runs=(run_2 run_3)
all_runs=(run_1)
this_root=$PWD
simlog=sim_log.log

# cnn
input_file=large-e4569-64x64-192k-cnn.ini
# bnn
input_file=large-e4569-64x64-192k-bnn-warm-1.ini
...
traine4569()
{
  ...
  #all_edges=(large-64x64-e9-96k)
  all_edges=(large-64x64-e4-32k large-64x64-e5-64k large-64x64-e6-96k large-64x64-e9-96k)
  ...
  do
    ...
    do
      ...
      mv stats.csv "e4569-stats-$e0-$p0-${f0:8}.csv"
    done
    echo "e4569-stats-$e0-${f0:8}.csv" >> $simlog
    python $this_root/report_l2_error.py e4569-stats-$e0*-${f0:8}.csv >> $simlog 
    mv e4569-stats-*-${f0:8}.csv $this_root/train/
...
teste4569()
{
  ...
  do
    ...
    python tmp.py $input_file -rf $f0
    mv stats.csv "e4569-stats-$e0-${f0:8}.csv"
    echo "e4569-stats-$e0-${f0:8}.csv" >> $simlog
    python $this_root/report_l2_error.py e4569-stats-$e0-${f0:8}.csv >> $simlog 
    mv e4569-stats-$e0-${f0:8}.csv $this_root/teste/
  done
