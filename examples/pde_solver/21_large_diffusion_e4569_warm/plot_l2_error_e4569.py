...
for i0 in range(len(summary_e456)):
    ...
    plt.xlim([-0.8,11.8])
    plt.xticks(loc, tick)
    plt.text(1.1, -0.175, "train", fontsize=20)
    plt.text(7.25, -0.175, "test", fontsize=20)
    ...
    # plt.savefig('l2_error_e4569_'+str(e4569)+'_cnn_rescale_physical.png', bbox_inches='tight')
    # plt.show()
