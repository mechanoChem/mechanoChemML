...
if __name__ == '__main__':
    ...
    # _inputs, _labels, _mean, _var, _std = problem.test(test_folder='new_test/s12/', plot_png=False)
    _inputs, _labels, _mean, _var, _std = problem.test(test_folder='new_test/s12/', plot_png=True)
