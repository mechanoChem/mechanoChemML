...
# def plot_each_bvp_results_with_quantitative_line(ra=0):
    # """ """
    # # cnn
    # saved_data = "results/2020-12-15T15-45-NN-nonlinear-30-bvp-final-1-cnn-x9-B256-E20000-I100-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-data16x16-nonlinear-DNS-30-E30-Nu0.3-20201215154513.pickle"
...
def output_inter_extra_with_reaction_force(sim_id=0):
    # saved_data = "results/2022-03-12T05-01-exp-10-57-NN-cnn-x10-B256-E10000-I100-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-..data-20220312050122.pickle"
    ...
    saved_data = "results/2022-06-13T08-37-exp-4-60-BNN-bnn-x10-B256-E20000-I100-mc100-1S1.0e-05-2S1.0e-03-Nadam-2.0e-06-..data-20220516210556-e20000-ra-ckpt19999.pickle"
...
def plot_forces(sim_id=0):
    ...
    if sim_id == 0:
        train = "results/2022-05-16T22-01-Destiny-NN-cnn-x10-B256-E10000-I100-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-..data-20220312050122-e-1-ra-ckpt9999-DNSF.npy"
        extra = "results/2022-05-16T22-01-Destiny-NN-cnn-x10-B256-E10000-I100-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-..data-20220312050122-e-1-ra-ckpt9999-ExtraF.npy"
        inter = "results/2022-05-16T22-01-Destiny-NN-cnn-x10-B256-E10000-I100-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-..data-20220312050122-e-1-ra-ckpt9999-InterF.npy"
    elif sim_id == 1:
        # train = "results/2022-05-16T22-23-Destiny-NN-cnn-x10-B256-E10000-I100-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-..data-20220312050122-e-1-ra-ckpt9999-DNSF.npy"
        # extra = "results/2022-05-16T22-23-Destiny-NN-cnn-x10-B256-E10000-I100-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-..data-20220312050122-e-1-ra-ckpt9999-ExtraF.npy"
        # inter = "results/2022-05-16T22-23-Destiny-NN-cnn-x10-B256-E10000-I100-mc1-1S0.0e+00-2S0.0e+00-Nadam-2.5e-04-..data-20220312050122-e-1-ra-ckpt9999-InterF.npy"

        # train = "results/2022-06-17T10-40-Destiny-BNN-cnn-x10-B256-E20000-I100-mc100-1S1.0e-05-2S1.0e-03-Nadam-2.0e-06-..data-20220516210556-e-1-ra-ckpt19999-DNSF.npy"
        # extra = "results/2022-06-17T10-40-Destiny-BNN-cnn-x10-B256-E20000-I100-mc100-1S1.0e-05-2S1.0e-03-Nadam-2.0e-06-..data-20220516210556-e-1-ra-ckpt19999-ExtraF.npy"
        # inter = "results/2022-06-17T10-40-Destiny-BNN-cnn-x10-B256-E20000-I100-mc100-1S1.0e-05-2S1.0e-03-Nadam-2.0e-06-..data-20220516210556-e-1-ra-ckpt19999-InterF.npy"
        train = "results/2022-07-08T10-46-Destiny-BNN-cnn-x10-B256-E20000-I100-mc100-1S1.0e-05-2S1.0e-03-Nadam-2.0e-06-..data-ckpt19999-e-1-ra-ckpt19999-DNSF.npy"
        extra = "results/2022-07-08T10-46-Destiny-BNN-cnn-x10-B256-E20000-I100-mc100-1S1.0e-05-2S1.0e-03-Nadam-2.0e-06-..data-ckpt19999-e-1-ra-ckpt19999-ExtraF.npy"
        inter = "results/2022-07-08T10-46-Destiny-BNN-cnn-x10-B256-E20000-I100-mc100-1S1.0e-05-2S1.0e-03-Nadam-2.0e-06-..data-ckpt19999-e-1-ra-ckpt19999-InterF.npy"
