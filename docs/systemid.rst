...
Description
===========
The system identification workflow uses a class of inverse modeling techniques that allows physics discovery from data. The example used here is identifying the governing equation of Turing pattern physics. The data and the bases in weak form are generated by MechanoChemFEM.
